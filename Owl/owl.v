...
Lemma up_tm_ty {m : nat} {n_label n_ty : nat}
...
Lemma up_list_tm_ty (p : nat) {m : nat} {n_label n_ty : nat}
  (sigma : fin m -> ty n_label n_ty) : fin m -> ty n_label n_ty.
Proof.
exact (funcomp (ren_ty id id) sigma).
Defined.
...
Lemma upId_tm_ty {m_label m_ty : nat} (sigma : fin m_ty -> ty m_label m_ty)
  (Eq : forall x, sigma x = var_ty m_label m_ty x) :
  forall x, up_tm_ty sigma x = var_ty m_label m_ty x.
Proof.
...
Lemma upId_list_tm_ty {p : nat} {m_label m_ty : nat}
  (sigma : fin m_ty -> ty m_label m_ty)
  (Eq : forall x, sigma x = var_ty m_label m_ty x) :
  forall x, up_list_tm_ty p sigma x = var_ty m_label m_ty x.
Proof.
exact (fun n => ap (ren_ty id id) (Eq n)).
Qed.
...
Lemma upExt_tm_ty {m : nat} {n_label n_ty : nat}
  (sigma : fin m -> ty n_label n_ty) (tau : fin m -> ty n_label n_ty)
  (Eq : forall x, sigma x = tau x) :
...
Lemma upExt_list_tm_ty {p : nat} {m : nat} {n_label n_ty : nat}
  (sigma : fin m -> ty n_label n_ty) (tau : fin m -> ty n_label n_ty)
  (Eq : forall x, sigma x = tau x) :
...
Lemma up_ren_subst_tm_ty {k : nat} {l : nat} {m_label m_ty : nat}
  (xi : fin k -> fin l) (tau : fin l -> ty m_label m_ty)
  (theta : fin k -> ty m_label m_ty)
  (Eq : forall x, funcomp tau xi x = theta x) :
...
Lemma up_ren_subst_list_tm_ty {p : nat} {k : nat} {l : nat}
  {m_label m_ty : nat} (xi : fin k -> fin l) (tau : fin l -> ty m_label m_ty)
  (theta : fin k -> ty m_label m_ty)
  (Eq : forall x, funcomp tau xi x = theta x) :
  forall x,
...
exact (fun n =>
       eq_trans
         (compRenRen_ty id id (upRen_tm_label zeta_label)
            (upRen_tm_ty zeta_ty) (funcomp id zeta_label)
            (funcomp id zeta_ty) (fun x => eq_refl) (fun x => eq_refl)
            (sigma n))
         (eq_trans
            (eq_sym
...
exact (fun n =>
       eq_trans
         (compRenRen_ty id id (upRen_list_tm_label p zeta_label)
            (upRen_list_tm_ty p zeta_ty) (funcomp id zeta_label)
            (funcomp id zeta_ty) (fun x => eq_refl) (fun x => eq_refl)
            (sigma n))
         (eq_trans
            (eq_sym
...
exact (fun n =>
       eq_trans
         (compRenSubst_ty id id (up_tm_label tau_label) (up_tm_ty tau_ty)
...
exact (fun n =>
       eq_trans
         (compRenSubst_ty id id (up_list_tm_label p tau_label)
            (up_list_tm_ty p tau_ty)
...
Lemma rinstInst_up_tm_ty {m : nat} {n_label n_ty : nat}
  (xi : fin m -> fin n_ty) (sigma : fin m -> ty n_label n_ty)
  (Eq : forall x, funcomp (var_ty n_label n_ty) xi x = sigma x) :
  forall x,
  funcomp (var_ty n_label n_ty) (upRen_tm_ty xi) x = up_tm_ty sigma x.
Proof.
exact (fun n => ap (ren_ty id id) (Eq n)).
Qed.
...
Lemma rinstInst_up_list_tm_ty {p : nat} {m : nat} {n_label n_ty : nat}
  (xi : fin m -> fin n_ty) (sigma : fin m -> ty n_label n_ty)
  (Eq : forall x, funcomp (var_ty n_label n_ty) xi x = sigma x) :
  forall x,
  funcomp (var_ty n_label n_ty) (upRen_list_tm_ty p xi) x =
  up_list_tm_ty p sigma x.
Proof.
exact (fun n => ap (ren_ty id id) (Eq n)).
Qed.
...
Ltac asimpl' := repeat (first
                 ...
                 | progress
                    unfold up_list_tm_tm, up_list_tm_ty, up_list_tm_label,
                     ...
                     upRen_ty_label, upRen_label_ty, up_list_label_label,
